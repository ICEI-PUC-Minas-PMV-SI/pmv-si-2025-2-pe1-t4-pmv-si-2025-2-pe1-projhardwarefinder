    ...
    const images = [
      { src: '../peca_procura/img/psu_bronze.png', alt: 'amd9060', potencia: 9, preco: 6, custobeneficio: 10 },
      { src: '../peca_procura/img/psu_silver.png', alt: 'rtx760', potencia: 2, preco: 10, custobeneficio: 2 },
      { src: '../peca_procura/img/psu_gold.png', alt: 'rtx3060', potencia: 6, preco: 8, custobeneficio: 7 },
      { src: '../peca_procura/img/psu_platinum.jpg', alt: 'rtx5090', potencia: 10, preco: 2, custobeneficio: 6 }
    ];
