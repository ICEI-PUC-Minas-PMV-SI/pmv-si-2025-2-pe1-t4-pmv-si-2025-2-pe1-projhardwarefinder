    ...
    const images = [
      { src: '../peca_procura/img/mobo_basic.png', potencia: 7, preco: 10, custobeneficio: 6 },
      { src: '../peca_procura/img/mobo_lower_mid.png', potencia: 8, preco: 9, custobeneficio: 7 },
      { src: '../peca_procura/img/mobo_upper_mid.png', potencia: 9, preco: 6, custobeneficio: 10 },
      { src: '../peca_procura/img/mobo_prime.png', potencia: 10, preco: 4, custobeneficio: 8 }
    ];
